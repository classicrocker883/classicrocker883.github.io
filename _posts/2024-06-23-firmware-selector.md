...
<body>
    ...
    <div class="form-row">
        ...
        <div class="select-container">
            <select id="options" onchange="updateCandidates(); handleOptionsChange();">
    ...
    <div id="secondaryOptionsDiv" style="display: none;">
        <div class="form-row">
            ...
            <div class="select-container">
                <select id="secondaryOptions" onchange="updateCandidates(); handleOptionsChange();">
    ...
    <div>
        <ul>
            ...
            <li>
                ...
                <a target="_blank" rel="noopener noreferrer nofollow"><img src="https://preview.redd.it/voxelab-aquila-c2-with-the-h32-chipset-v0-h2ctv1nh4g0d1.jpg?width=640&amp;crop=smart&amp;auto=webp&amp;s=38f534aacd0f45b276fd21b0efaff7f75067045e" style="width: 150px; height: auto;" alt="12864 Monochrome Display"></a>
            ...
            async function fetchReleaseData(selectedModel) {
                ...
                if (currentReleaseTag !== "latest") {
                    ...
                    if (selectedRelease) {
                        ...
                        const latestRelease = await fetchLatestReleaseDetails();
                        actualBaseTagName = latestRelease ? latestRelease.tag_name : null;
                        console.warn("Falling back to latest release as explicit tag was not found.");
                    }
                } else {
                    const latestRelease = await fetchLatestReleaseDetails();
                    actualBaseTagName = latestRelease ? latestRelease.tag_name : null;
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            if (data.assets && data.assets.length > 0) {
                                console.log(`Successfully fetched assets for tag: ${tagToTry}`);
                                return { assets: data.assets, actualTagNameUsed: tagToTry };
                            }
                        }
                    } catch (error) {
                        console.warn(`Attempting tag ${tagToTry} failed or returned no assets. Trying next...`, error);
                    }
                }
                console.error("No release assets found for the selected model and revisions after all attempts.");
                return { assets: [], actualTagNameUsed: null };
            }
