...
<body>
    ...
    <p>If you are not sure which <code>Model</code>/<code>Board</code> to choose, see<br>
        <a href="#info">ℹ️ Selection Guide</a></p>
    ...
    <div id="releases-container" style="display: none;">
        <p></p><p></p><p>Select one to load:</p>
    ...
    <div class="form-row">
        <div class="label-container">
            <label for="type"><i class="icon fas fa-microchip"></i> Board:</label>
        </div>
        <div class="select-container">
            <select id="type">
    ...
    <div class="form-row">
        ...
        <div class="select-container">
            <select id="options">
                ...
                <option value="-PLR" title="(DEPRECIATED) -PLR">Power-loss Recovery</option>
            </select>
        </div>
    </div>
    ...
    <div id="deprecatedPopup" class="popup-overlay">
        <div class="popup-content">
            <h3>Depreciated!</h3>
            <p>Power-loss Recovery option for this firmware is deprecated. <br>
                It is only here for older releases. <br>
                Most recent ones now have this enabled.</p>
    ...
    <br>
    <hr>
    <p style="text-align: center; font-size: 1.1em;">If you find there is an error loading after many attempts, <br>
        you may have reached the <a href="#api-rate-limit-header">API limit</a>.</p>
    <hr>
    ...
    <hr>
    <h2 id="info">ℹ️ Selection Guide</h2>
    <p>If an option is not selectable (greyed out), select a different <b>Model</b>. <br>
        See <a href="#specialversions"><b>Special Versions</b></a> for more details.
    </p>
    <div>
        <ul>
            <li>
                <b>Model</b>: <i>Aquila C2</i> - with monochrome 12864 LCD <i>ONLY</i>.
            </li>
            <li>
                <b>Model</b>: <i>HC32</i> - <b>Aquila</b> with color LCD <i>ONLY</i> (<code>H32</code> sticker).
            </li>
            <li>
                <b>Board</b>: <i>BTT SKR Mini E3</i> - only selectable under <b>Aquila</b> and <b>Ender-3 V2/S1</b>.
            </li>
            <li>
                <b>Board</b>: <i>Creality E3 Free-runs</i> - only selectable under <b>Ender-3 V2/S1</b>.
            </li>
        </ul>
    </div>
    ...
    <h3 id="specialversions">Special Versions</h3>
    <dl>
    ...
    <div>
        <ul>
            <li>
                ...
                <a href="https://github.com/classicrocker883/MRiscoCProUI/blob/HEAD/display%20assets/tjc_update.zip?raw=true" rel="nofollow">📲Click to Download <code>tjc_update.zip</code></a><br>
                (for TJC screen update if you haven't already)
                <p></p>
            </li>
            <br>
            <li>
                <b>Aquila LCD Display Assets</b><br>
                ...
                <p>
                    <a href="https://downgit.github.io/#/home?url=https://github.com/classicrocker883/MRiscoCProUI/tree/HEAD/display%20assets/Aquila%20Display%20Firmware/Firmware%20Sets" rel="nofollow">🗂️Click to Download DWIN_SET</a> - (DWIN units)
                <p></p>
                </p>
            </li>
            <br>
            <li>
                ...
                <p>
                    <a href="https://downgit.github.io/#/home?url=https://github.com/classicrocker883/MRiscoCProUI/tree/HEAD/display%20assets/Creality%20Display%20Firmware/DWIN_SET" rel="nofollow">🗂️Click to Download DWIN_SET</a> - (DWIN units)<br>
                    <a href="https://downgit.github.io/#/home?url=https://github.com/classicrocker883/MRiscoCProUI/tree/HEAD/display%20assets/Creality%20Display%20Firmware/private" rel="nofollow">📲Click to Download private</a> - (DACAI units)
                <p></p>
                </p>
            </li>
            <br>
            <li>
                ...
                <img src="https://github.com/classicrocker883/MRiscoCProUI/raw/HEAD/display%20assets/Giadej%20compilation/preview1.jpg" style="width: 150px; height: auto;" alt="Giadej LCD Display Assets" />
                <p>
                    <a href="https://downgit.github.io/#/home?url=https://github.com/classicrocker883/MRiscoCProUI/tree/HEAD/display%20assets/Giadej%20compilation/DWIN_SET" rel="nofollow">🗂️Click to Download DWIN_SET</a> - (DWIN units)<br>
                    <a href="https://downgit.github.io/#/home?url=https://github.com/classicrocker883/MRiscoCProUI/tree/HEAD/display%20assets/Giadej%20compilation/private" rel="nofollow">📲Click to Download private</a> - (DACAI units)
                    <p></p>
                </p>
            </li>
            <br>
            <li>
                <b>12864 Monochrome Display</b><br>
                <img src="https://preview.redd.it/voxelab-aquila-c2-with-the-h32-chipset-v0-h2ctv1nh4g0d1.jpg?width=640&amp;crop=smart&amp;auto=webp&amp;s=38f534aacd0f45b276fd21b0efaff7f75067045e" style="width: 150px; height: auto;" alt="12864 Monochrome Display">
                <p>See Model: Aquila C2</p>
            </li>
        </ul>
    </div>
    <hr>
    <h2 id="api-rate-limit-header">GitHub API Rate Limit</h2>
    <h3>Enter your GitHub &nbsp;<i>Personal Access Token</i> :</h3>
    <input type="password" id="tokenInput" placeholder="Paste your token here" size="40" />
    <button id="fetchBtn">Enter</button>
    <p>
        <h4>Setting a personal access token <strong>(PAT)</strong></h4>
        <p>Select one to create a new token:</p>
        <ol style="list-style-type: upper-roman;">
            <li><a href="https://github.com/settings/personal-access-tokens/new"><strong>Fine-Grained PAT</strong></a></li>
            <ul>
                <li><strong>Repository access:</strong></li>
                <ul>
                    <li>
                        <em>Public repositories</em>
                        <span style="padding-left: 40px; font-size: 0.8em;">Read-only access to public repositories.</span>
                    </li>
                </ul>
            </ul>
            <li><a href="https://github.com/settings/tokens/new"><strong>Classic PAT</strong></a></li>
            <ul>
                <li><strong>Repository Permissions:</strong></li>
                <ul>
                    <li>
                        <em>read:public_key</em>
                        <span style="padding-left: 40px; font-size: 0.8em;">Read user public keys</span>
                    </li>
                </ul>
            </ul>
        </ol>
